    ...
    <div className="hiw-page">
      ...
      <main className="hiw-main" ref={mainRef} role="main">
        ...
        <section className="hiw-permits" aria-labelledby="hiw-permits-title">
          <h2 id="hiw-permits-title" className="hiw-section-title">Permits Handled by TheO</h2>
          <ul className="hiw-permits-list">
            <li>Public Event Permits</li>
            <li>Road Closures & Traffic Management Orders</li>
            <li>Casual Trading Licences</li>
            <li>Film & Photography Permits</li>
            <li>Parking Bay Suspensions</li>
            <li>Alcohol Licences</li>
            <li>Temporary Structure Approvals</li>
            <li>Noise Management Notifications</li>
            <li>Protest Notifications & Risk Registers</li>
          </ul>
        </section>
